  ...
  "小1 くりさがり": [
    {
      ...
      reason:
        "10から引くイメージをイラストで理解できるので、数字が苦手な子でも入りやすいです。",
    },
    {
      level: "つまずき",
      name: "教科書ぴったりドリル 小1さんすう くり下がり",
      reason:
        "学校と同じ順番でくり下がりを練習でき、テスト前の復習にも使いやすい構成です。",
    },
    {
      level: "高度",
      name: "算数パズル 1年生 くり下がり編",
      reason:
        "文章題やパズル形式で、くり下がりをしっかり定着させたいときに向いています。",
    },
  ],
  "小2 九九": [
    {
      ...
      name: "はじめての九九ドリル",
      reason:
        "2の段・5の段など覚えやすいところから始められ、九九が苦手な子のとっかかりに最適です。",
    },
    {
      level: "つまずき",
      name: "小学2年 九九ドリル 標準",
      reason:
        "読み・書き・テストが一冊にまとまっており、学校のテスト対策にちょうど良いボリュームです。",
    },
    {
      level: "高度",
      name: "九九パズルドリル",
      reason:
        "九九を使ったパズルや迷路で、九九が得意な子の頭をさらに使わせたいときにおすすめです。",
    },
  ],
  "小2 音読": [
    {
      ...
      reason:
        "1分で読めるくらいの短いお話が中心で、音読が苦手な子でも取り組みやすい構成です。",
    },
    {
      level: "つまずき",
      name: "小学2年 国語 音読・読解ドリル",
      reason:
        "音読と簡単な質問がセットになっていて、『読んで終わり』になりにくいのが特徴です。",
    },
    {
      level: "高度",
      name: "心にひびく名作音読集",
      reason:
        "少し長めのお話をじっくり読むことで、表現力や感情移入の力も育てたいときに向いています。",
    },
  ],
  "小1 くりあがり": [
    {
      ...
      reason:
        "10のかたまりをイラストで理解できて、数字にまだ慣れていない子でも取り組みやすい。",
    },
    {
      level: "つまずき",
      name: "教科書ぴったりドリル 小1さんすう くり上がり",
      reason:
        "学校と同じ順番でくり上がりを練習でき、テスト前の確認にちょうど良い。",
    },
    {
      level: "高度",
      name: "算数パズル 1年生 くり上がり編",
      reason:
        "文章題やパズル形式で、得意な子の頭をさらに使わせたいときに向いている。",
    },
  ],
  "小1 ひらがな": [
    {
      ...
      name: "はじめてのひらがなドリル",
      reason:
        "なぞり書き中心で、えんぴつに慣れていない子でも楽しく練習できる。",
    },
    {
      level: "つまずき",
      name: "小学1年 ひらがな・カタカナドリル",
      reason:
        "読み書き両方をバランスよく練習できる標準タイプ。宿題の補強にも。",
    },
    {
      level: "高度",
      name: "ことばあそび ひらがなパズル",
      reason:
        "しりとりやことばあそびで、ひらがなを使いこなせるようにしたい子向け。",
    },
  ],
  "小3 漢字": [
    {
      ...
      reason:
        "読み中心で、まずは漢字に慣れることを優先したい子に合っている。",
    },
    {
      level: "つまずき",
      name: "小学3年 漢字ドリル 標準",
      reason:
        "書き＋テスト形式で、学校のテスト対策にちょうど良い構成。",
    },
    {
      level: "高度",
      name: "漢字パズル 小学3年",
      reason:
        "クロスワードやクイズで、漢字好きな子をさらに伸ばしたいときにおすすめ。",
    },
  ],
};
...
export default function KidsPage() {
  ...
  const handleQuiz = () => {
    const q1 = (
      document.querySelector('input[name="q1"]:checked') as
        | HTMLInputElement
        | null
    )?.value;
    const q2 = (
      document.querySelector('input[name="q2"]:checked') as
        | HTMLInputElement
        | null
    )?.value;
    const q3 = (
      document.querySelector('input[name="q3"]:checked') as
        | HTMLInputElement
        | null
    )?.value;
      ...
      <div className="container">
        ...
        <div className="fixed-block">
          ...
          <div className="book-item">
            <div className="book-title">
              年長〜小2向け：読み聞かせにおすすめの絵本リスト
            </div>
            <p className="small-note">
              「1回10分くらいで読める」「親子で感想を話しやすい」絵本を中心にまとめたnote記事です。
            </p>
            <a className="amazon-link" href="#" target="_blank">
              noteで見る
            </a>
          </div>
        </div>
        ...
        <div className="columns">
          ...
          <div className="column-article">
            ...
            <p>
              小1でいちばん多いつまずきが「くりあがり・くりさがり」です。10というまとまりのイメージがまだ弱いと、「9のつぎは10」「10を1と0に分ける」といった感覚がピンと来ません。
              また、ノートのマスから数字がはみ出してしまう子は、そもそも「位」を意識するのが難しいことも多いです。
            </p>
            <p>
              まずは、10個のブロックを「まとめて1つのかたまり」にする遊びから始めたり、「9＋1＝10」のパターンだけをくり返し練習するのがおすすめです。
            </p>
            <p className="small-note">
              おすすめ：くりあがりに特化した算数ドリルや、10のまとまりを絵で説明してくれる教材。「小1 くりあがり」と検索して、ぴったりのドリルを探してみてください。
            </p>
          </div>
          ...
          <div className="column-article">
            ...
            <p>
              ひらがな・カタカナは、「書けない＝遅れている」ではありません。読む力のほうが先に育つことも多く、まずは「読める」ことをたくさんほめてあげることが大切です。
            </p>
            <p>
              書くときは、最初からきれいさを求めすぎないこと。大きく・ゆっくり・なぞり書きから始めて、「自分で書けた！」という成功体験を積み重ねていきましょう。
            </p>
            <p className="small-note">
              おすすめ：なぞり書き中心のひらがなドリルや、音読しやすい短い絵本。「小1 ひらがな」「小2 音読」などで検索してみてください。
            </p>
          </div>
          ...
          <div className="column-article">
            ...
            <p>
              子どもの勉強には、「コツコツ反復型」「ひらめき思考型」「マイペース集中型」など、いろいろなタイプがあります。タイプに合わないやり方を無理に続けると、やる気そのものが落ちてしまいます。
            </p>
            <p>
              例えば、反復型の子には「同じドリルを毎日少しずつ」がおすすめ。ひらめき型の子には、パズルや文章題など、少し考える問題を混ぜると楽しめます。マイペース型の子には、「短い時間で終わる」「できたらすぐほめる」仕組みが向いています。
            </p>
            <p className="small-note">
              上の「勉強タイプ診断」でお子さんのタイプをチェックしてから、タイプに合ったドリルを選んであげると、学習がぐっとスムーズになります。
            </p>
          </div>
        </div>
      </div>
