  ...
  return (
    <>
      ...
      <main>
        ...
        <table>
          <tbody>
            ...
            <tr>
              ...
              <td>
                080-5471-5284<br/>
                <span style={{fontSize:'11px', color:'var(--text-s)'}}>※受付時間：平日10:00〜17:00</span>
              </td>
            </tr>
            <tr>
              <th>問い合わせ窓口（メールアドレス）</th>
              <td>
                <a href="mailto:twinklelab2026@gmail.com" className="gold-link">twinklelab2026@gmail.com</a>
              </td>
            </tr>
            <tr>
              <th>お問い合わせ</th>
        ...
        <div className="section-title">返品・交換不良品・解約について</div>
        <table>
          <tbody>
            <tr>
              ...
              <td>
                ...
                返金をご希望の場合は、<a href="/contact" className="gold-link">お問い合わせフォーム</a>または
                <a href="mailto:twinklelab2026@gmail.com" className="gold-link">twinklelab2026@gmail.com</a>までご連絡ください。
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <p style={{fontSize:'12px', color:'var(--text-s)', textAlign:'right'}}>最終更新日：2026年6月</p>
      </main>
