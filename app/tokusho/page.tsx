...
<head>
  ...
  <title>特定商取引法に基づく表記 | Twinkle Lab</title>
...
<header class="page-header">
  <a href="/" class="site-name">Twinkle Lab</a>
...
<main>
  ...
  <div class="section-title">販売業者情報</div>
  <table>
    <tbody>
      <tr>
        <th>販売事業者名</th>
      ...
      <tr>
        <th>本社所在地</th>
        <td>〒355-0211<br/>埼玉県比企郡嵐山町杉山596</td>
      </tr>
      <tr>
        <th>問い合わせ窓口（電話番号）</th>
        <td>080-5471-5284<br/>
          <span style="font-size:11px;color:var(--text-s)">※受付時間：平日10:00〜17:00</span>
        </td>
      </tr>
      <tr>
        <th>問い合わせ窓口（メールアドレス）</th>
        <td><a href="mailto:twinklelab2026@gmail.com" class="gold-link">twinklelab2026@gmail.com</a></td>
      </tr>
      <tr>
        <th>お問い合わせ</th>
        <td><a href="/contact" class="gold-link">お問い合わせフォームはこちら</a></td>
      </tr>
    </tbody>
  </table>

  <div class="section-title">サービス・販売について</div>
  <table>
    <tbody>
      <tr>
        <th>販売サービス名</th>
  ...
  <div class="section-title">返品・交換不良品・解約について</div>
  <table>
    <tbody>
      <tr>
        <th>返品・交換不良品・解約について</th>
        <td>
          デジタルコンテンツの性質上、購入完了後のキャンセル・返金は原則承っておりません。<br/>
          ご購入前にサービス内容をよくご確認の上お手続きください。<br/><br/>
          システム障害等、当社の責に帰すべき事由によりサービスをご提供できない場合は、全額返金いたします。<br/>
          返金をご希望の場合は、<a href="/contact" class="gold-link">お問い合わせフォーム</a>または<a href="mailto:twinklelab2026@gmail.com" class="gold-link">twinklelab2026@gmail.com</a>までご連絡ください。
        </td>
      </tr>
    </tbody>
  </table>

  <div class="section-title">免責事項</div>
  <div class="note-box">
  ...
  <p style="font-size:12px;color:var(--text-s);text-align:right">最終更新日：2026年6月</p>
</main>
